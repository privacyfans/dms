...
HAVING
    ...
    public function show($id)
    {
        ...
        //Cek apakah user ini perlu lock (hanya SPV1, SPV2, SPV3, SPV4) dan diakses dengan parameter lock
        $needsLock = in_array($currentRole, [ 'spv2', 'spv3', 'spv4']) && request()->has('lock');
