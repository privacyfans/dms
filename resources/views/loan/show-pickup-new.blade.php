...
<link href="{{URL::asset('assets/plugins/fileuploads/css/fileupload.css')}}" rel="stylesheet" type="text/css"/>
        ...
        .accordion-gray .card-header-dark a.collapsed,.accordion .card-header-dark a,.accordion .card-header-dark a.collapsed,.accordion .card-header-dark a.collapsed:focus,.accordion .card-header-dark a.collapsed:hover,.accordion .card-header-dark a:focus,.accordion .card-header-dark a:hover{
            color:#000;
            display: block;
            padding: 14px 20px;
            position: relative;
                                                                ...
                                                                @foreach($kat->dokumen as $dokumen)
                                                                    ...
                                                                    @php
                                                                        ...
                                                                        $tampilkanDokumen = (isKupeg($products->jenis_produk) && $dokumen->kupeg) ||
                                                                                            ...
                                                                                            (isKupenHybrid($products->jenis_produk) && $dokumen->kupen_hybrid);
                                                                        //$tampilkanDokumen=true;
                                                                    @endphp
                                                                                ...
                                                                                <div aria-multiselectable="true" class="accordion" id="accordion" role="tablist">
                                                                                    <div class="d-flex flex-row justify-content-between align-items-center bg-gray-100">
                                                                                        <div class="pd-1 bg-gray-100">
                                                                                            <div class="card-header-{{ get_warna_new($datafile->loan_app_no,$dokumen->nama_dokumen,$dokumen->label_only )}}" id="headingOne" role="tab">
                                                                                                <a aria-controls="collapseOne{{$dokumen->id}}" aria-expanded="true" data-toggle="collapse" href="#collapseOne{{$dokumen->id}}">
                                                                                                    ...
                                                                                                    @if(isKupeg($products->jenis_produk))
                                                                                                        ...
                                                                                                        {!! getBadge($dokumen->is_mandatory_kupeg, $dokumen->nama_dokumen,$dokumen->label_only,$datafile->status_pernikahan,$datafile->status_deviasi,$datafile->early,$datafile->status_usia_debitur,$datafile->status_fronting_agent,$datafile->status_kantor,$datafile->fasilitas,$datafile->status_pegawai,$datafile->date_input) !!}


                                                                                                    @elseif(isKupen($products->jenis_produk))

                                                                                                        {!! getBadge($dokumen->is_mandatory_kupen, $dokumen->nama_dokumen,$dokumen->label_only,$datafile->status_pernikahan,$datafile->status_deviasi,$datafile->early,$datafile->status_usia_debitur,$datafile->status_fronting_agent,$datafile->status_kantor,$datafile->fasilitas,$datafile->status_pegawai,$datafile->date_input) !!}

                                                                                                    @elseif(isKupenHybrid($products->jenis_produk))

                                                                                                    {!! getBadge($dokumen->is_mandatory_kupen_hybrid, $dokumen->nama_dokumen,$dokumen->label_only,$datafile->status_pernikahan,$datafile->status_deviasi,$datafile->early,$datafile->status_usia_debitur,$datafile->status_fronting_agent,$datafile->status_kantor,$datafile->fasilitas,$datafile->status_pegawai,$datafile->date_input) !!}
                                                                                            ...
                                                                                            @if($dokumen->subDokumen->isEmpty())
                                                                                                <div class="form-group-fileupload">
                                                                                                    <div class="input-group">
                                                                                                        ...
                                                                                                        <input type="file" name="{{$dokumen->nama_dokumen}}" id="{{$dokumen->nama_dokumen}}" class="form-control" {{ $dokumen->is_mandatory_kupen_hybrid ? 'required' : '' }}>
                                                                                        ...
                                                                                        @foreach($dokumen->subDokumen as $subDokumen)
                                                                                            @php
                                                                                                $tampilkanSubDokumen = (isKupeg($products->jenis_produk) && $subDokumen->kupeg) ||
                                                                                                                       ...
                                                                                                                       (isKupenHybrid($products->jenis_produk) && $subDokumen->kupen_hybrid);
                                                                                                //$tampilkanSubDokumen =true;
                                                                                            @endphp
                                                                                            ...
                                                                                            @if($tampilkanSubDokumen)
                                                                                                <div class="ml-4">
                                                                                                    ...
                                                                                                    <div aria-multiselectable="true" class="accordion" id="accordionSubdokumen" role="tablist">
                                                                                                        <div class="d-flex flex-row justify-content-between bg-gray-100">
                                                                                                            <div class="pd-1 bg-gray-100">
                                                                                                                <div class="card-header-{{ get_warna_new($datafile->loan_app_no,$subDokumen->nama_sub_dokumen,'0' )}}" id="headingOne" role="tab">
                                                                                                                    ...
                                                                                                                    {{ $subDokumen->nama_sub_dokumen }}
                                                                                                                                @if(isKupeg($products->jenis_produk))
                                                                                                                                        ...
                                                                                                                                        {!! getBadge($subDokumen->is_mandatory_kupeg, $subDokumen->nama_sub_dokumen,0,$datafile->status_pernikahan,$datafile->status_deviasi,$datafile->early,$datafile->status_usia_debitur,$datafile->status_fronting_agent,$datafile->status_kantor,$datafile->fasilitas,$datafile->status_pegawai,$datafile->date_input) !!}

                                                                                                                                @elseif(isKupen($products->jenis_produk))

                                                                                                                                        {!! getBadge($subDokumen->is_mandatory_kupen, $subDokumen->nama_sub_dokumen,0,$datafile->status_pernikahan,$datafile->status_deviasi,$datafile->early,$datafile->status_usia_debitur,$datafile->status_fronting_agent,$datafile->status_kantor,$datafile->fasilitas,$datafile->status_pegawai,$datafile->date_input) !!}
                                                                                                                                @elseif(isKupenHybrid($products->jenis_produk))

                                                                                                                                   {!! getBadge($subDokumen->is_mandatory_kupen_hybrid, $subDokumen->nama_sub_dokumen,0,$datafile->status_pernikahan,$datafile->status_deviasi,$datafile->early,$datafile->status_usia_debitur,$datafile->status_fronting_agent,$datafile->status_kantor,$datafile->fasilitas,$datafile->status_pegawai,$datafile->date_input) !!}
                                                                                                        ...
                                                                                                        <div aria-labelledby="headingTwo" class="collapse" data-parent="#accordionSubdokumen" id="collapseTwo{{$subDokumen->id}}" role="tabpanel">
                                                                                                            <div class="uploaded-files-container">
                                                                                                            <ul class="uploaded-files-list" id="uploaded-files-list-{{ $subDokumen->id }}">
