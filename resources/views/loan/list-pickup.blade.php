        ...
        <tr>
            ...
            <td>
                {{-- <form action="{{ route('loans.destroy',$br->loan_app_no ) }}" method="POST"> --}}
                                ...
                                $br->modul=='KUPEN UMUM') && $br->fasilitas!='3'
                                )
                                <a class="btn btn-info" href="{{ route('datafile.show_pickup_new',$br->loan_app_no) }}">Show New</a>
                                @else
                                <a class="btn btn-info" href="{{ route('datafile.show_pickup',$br->loan_app_no) }}">Show</a>
                                @endif
