                ...
                <div aria-multiselectable="true" class="accordion" id="accordion" role="tablist">
                    ...
                    <div class="card mb-0">
                        <div class="card-header" id="heading{{ ++$i }}" role="tab">
                            <a aria-controls="collapse{{ $i }}" aria-expanded="true" data-toggle="collapse" href="#collapse{{ $i }}">{!! $br->title !!}</a>
                        </div>
                        <div aria-labelledby="heading{{ $i }}" class="collapse" data-parent="#accordion" id="collapse{{ $i }}" role="tabpanel">
                            <div class="card-body">
                                {!! $br->desc !!}
                                <p>Link Document: <a target="_blank" href="/uploads/{{ $br->file }}">{{$br->file}}</a></p>
                            </div>
                        </div>
                    </div>
                    @endforeach
