					...
					<div class="col-lg-12">
						...
						@endif
										...
										<!-- <div class="ml-auto">
											...
											<div class="col-sm">
												<a href="{{url('daily-transaction')}}">
													<div class="card"  style="max-width: 100%;background-color: #f5bf41 !important;">
														
															<div class="card-body iconfont text-left">
																<div class="d-flex justify-content-between">
																	<h4 class="card-title mb-3" style="color:black !important;">Daily Transaction</h4>
																</div>
																<div class="d-flex mb-0">
																	<div class="">
																		<h1 class="mb-1 font-weight-bold" style="color:black !important;">{{ $totaldailyprocessed }} / {{ $totaldaily }}</h1>
																		<p class="mb-2 tx-12 text-muted" style="color:black !important;"><i class="fas fa-arrow-circle-up text-success"></i> Daily Transaction <br> <br>  <br></p>
																	</div>
											...
											<div class="col-sm">
												<a href="{{url('daily-bpr2')}}">
													<div class="card"  style="max-width: 100%;background-color: #9feb66 !important;">
														<div class="card-body iconfont text-left">
															<div class="d-flex justify-content-between">
																<h4 class="card-title mb-3" style="color:black !important;">Waiting Verify TEAM LEADER</h4>
															</div>
															<div class="d-flex mb-0">
																<div class="">
																	<h1 class="mb-1 font-weight-bold" style="color:black !important;">{{ $waitingdailybpr2 }}</h1>
																	<p class="mb-2 tx-12 text-muted" style="color:black !important;"><i class="fas fa-arrow-circle-up text-success"></i>Dokumen yang belum di verifikasi oleh DCRM TEAM LEADER.<br><br></p>
																</div>
																	<div class="card-chart bg-info-transparent brround ml-auto mt-0">
							...
							<div class="col-lg-12">
								<div class="card mg-b-20">
									<div class="card-body d-flex p-3">
										<div class="card-title mb-0 mg-t-8" style="color:#0a5ef2 !important;">Pending Task</div>
										<!-- <div class="ml-auto">
											<a class="d-block tx-20" data-placement="top" data-toggle="tooltip" title="" href="#" data-original-title="Add New User"><i class="si si-plus text-muted"></i></a></div> -->
									</div>
								</div>
							...
							<div class="col-lg-4">
								...
								@endif
								<div class="card"  style="max-width: 30rem;background-color: #9feb66 !important;">
									<div class="card-body iconfont text-left">
										<div class="d-flex justify-content-between">
											<h4 class="card-title mb-3" style="color:black !important;">Waiting Verify TEAM LEADER</h4>
										</div>
										<div class="d-flex mb-0">
											<div class="">
												<h1 class="mb-1   font-weight-bold" style="color:black !important;">{{ $total_spv3 }}</h1>
												<p class="mb-2 tx-12 text-muted" style="color:black !important;"><i class="fas fa-arrow-circle-up text-success"></i> Dokumen yang belum di verifikasi oleh TEAM LEADER</p>
											</div>
											<div class="card-chart bg-info-transparent brround ml-auto mt-0">
												<div class="badge badge-warning">DCRM</div>
											</div>
							...
							<div class="col-lg-12">
								<div class="card mg-b-20">
									<div class="card-body d-flex p-3">
										<div class="main-content-label mb-0 mg-t-8" style="color:#0a5ef2 !important;">TBO Task</div>
										<!-- <div class="ml-auto">
											<a class="d-block tx-20" data-placement="top" data-toggle="tooltip" title="" href="#" data-original-title="Add New User"><i class="si si-plus text-muted"></i></a></div> -->
									</div>
								</div>
							...
							<a href="{{url('tbo')}}">
								...
								<div class="card"  style="max-width: 17rem;background-color: #f5bf41 !important;">
									<div class="card-body iconfont text-left">
										<div class="d-flex justify-content-between">
											<h4 class="card-title mb-3" style="color:black !important;">Total TBO &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h4>
										</div>
										<div class="d-flex mb-0">
											<div class="">
												<h1 class="mb-1   font-weight-bold" style="color:black !important;">{{ $total_tbo }}</h1>
												<p class="mb-2 tx-12 text-muted" style="color:black !important;"><i class="fas fa-arrow-circle-up text-success"></i> Dokumen yang berstatus TBO  <br> <br></p>
											</div>
											<div class="card-chart bg-primary-transparent brround ml-auto mt-0">
												<div class="badge badge-info">All</div>
											</div>
							...
							<a href="{{url('tbo_overdue')}}">
								...
								<div class="card"  style="max-width: 17rem;background-color: #f5bf41 !important;">
									<div class="card-body iconfont text-left">
										<div class="d-flex justify-content-between">
											<h4 class="card-title mb-3" style="color:black !important;">Data Loan All TBO Overdue</h4>
										</div>
										<div class="d-flex mb-0">
											<div class="">
												<h1 class="mb-1   font-weight-bold" style="color:black !important;">{{ $total_tbo_overdue }}</h1>
												<p class="mb-2 tx-12 text-muted" style="color:black !important;"><i class="fas fa-arrow-circle-up text-success"></i> Dokumen yang berstatus TBO Overdue <br> <br></p>
											</div>
											<div class="card-chart bg-primary-transparent brround ml-auto mt-0">
												<div class="badge badge-info" >All</div>
											</div>
							...
							<a href="{{url('tbo_overdue_pending')}}">
								...
								<div class="card"  style="max-width: 17rem;background-color: #35b5f4 !important;">
									<div class="card-body iconfont text-left">
										<div class="d-flex justify-content-between">
										...
										<div class="d-flex mb-0">
											<div class="">
												<h1 class="mb-1   font-weight-bold" style="color:white !important;">{{ $total_tbo_pending }}</h1>
												<p class="mb-2 tx-12 text-muted" style="color:white !important;"><i class="fas fa-arrow-circle-up text-success"></i> Dokumen yang berstatus TBO Pending <br> <br></p>
											</div>
											<div class="card-chart bg-primary-transparent brround ml-auto mt-0">
												<div class="badge badge-info">All</div>
											</div>
							...
							<div class="col-sm">
								...
								@endif
								<div class="card"  style="max-width: 17rem;background-color: #9feb66 !important;">
									<div class="card-body iconfont text-left">
										<div class="d-flex justify-content-between">
							...
							<div class="col-sm">
								...
								<div class="card"  style="max-width: 17rem;background-color: #9feb66 !important;">
									<div class="card-body iconfont text-left">
										<div class="d-flex justify-content-between">
											<h4 class="card-title mb-3" style="font-size: color:black !important;">Waiting TBO TEAM LEADER </h4>
										</div>
										<div class="d-flex mb-0">
											<div class="">
												<h1 class="mb-1   font-weight-bold" style="color:black !important;">{{ $total_spv3_tbo }}</h1>
												<p class="mb-2 tx-12 text-muted" style="color:black !important;"><i class="fas fa-arrow-circle-up text-success"></i> Dokumen yang belum di verifikasi oleh TEAM LEADER</p>
											</div>
											<div class="card-chart bg-info-transparent brround ml-auto mt-0">
												<div class="badge badge-warning">DCRM</div>
