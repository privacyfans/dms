...
<form id="formInternalMemo" action="{{ route('internal-memo.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="pd-30 pd-sm-40 bg-gray-100">
                        ...
                        <div class="row row-xs align-items-center mg-b-20">
                            <div class="col-md-12">
                                <label class="form-label mg-b-0">Upload Files (PDF, PNG, JPG, JPEG - Max 2MB each)</label>
                            </div>
                            <div class="col-md-12 mg-t-5">
