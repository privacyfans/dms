...
@section('content')
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
                <h2>Change Setting TBO Overdue</h2>
            </div>
    ...
    <form action="{{ route('branch_tbo.update',$branch_tbo->id) }}" method="POST">
        @csrf
        @method('PUT')
                    ...
                    <div class="card-body">
                        ...
                        <div class="pd-30 pd-sm-40 bg-gray-100">
                            ...
                            <div class="row row-xs align-items-center mg-b-20">
                                ...
                                <div class="col-md-12 mg-t-5">
                                    <input type="text" name="purpose_jml" value="{{ $branch_tbo->purpose_jml }}" class="form-control" placeholder="Jumlah TBO">
                                </div>
                            </div>
