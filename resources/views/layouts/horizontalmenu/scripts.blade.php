		...
		<script src="{{URL::asset('assets/plugins/jquery/jquery.form.min.js')}}"></script>
		<!-- Bootstrap4 js-->
		...
		<script src="{{URL::asset('assets/js/pdfobject.js')}}"></script>
		<script src="{{URL::asset('assets/js/ezoom.js')}}"></script>
		@yield('scripts')
