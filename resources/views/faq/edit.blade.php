...
@section('content')
    ...
    <form id="formFAQ" action="{{ route('faq.update',$faq->id) }}" method="POST">
        @csrf
        @method('PUT')
                    ...
                    <div class="card-body">
                        ...
                        <div class="pd-30 pd-sm-40 bg-gray-100">
                            ...
                            <div class="row row-xs align-items-center mg-b-20">
                                ...
                                <div class="col-md-12 mg-t-5">
                                    {{-- <input type="text" name="answer" value="{{ $faq->answer }}" class="form-control" placeholder="Answer"> --}}
                                    <div id="answerEditor">
                                        
									</div>
                                    {{-- <textarea name="answer" col=  placeholder="Add Answer" class="form-control" rows="3">{{ $faq->answer }}</textarea> --}}
                                </div>
                            </div>
