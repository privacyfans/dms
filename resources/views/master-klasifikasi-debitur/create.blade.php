...
<div class="row">
    <div class="col-lg-12 margin-tb">
        <div class="pull-left">
            <h2>Add New Klasifikasi Debitur</h2>
        </div>
...
<form action="{{ route('master-klasifikasi-debitur.store') }}" method="POST">
    @csrf
            ...
            <div class="card">
                <div class="card-body">
                    <div class="main-content-label mg-b-5">
                        Create Master Klasifikasi Debitur
                    </div>
                    <div class="pd-30 pd-sm-40 bg-gray-100">
                        <div class="row row-xs align-items-center mg-b-20">
                            ...
                            <div class="col-md-12 mg-t-5">
                                <input type="text" name="klasifikasi_debitur" class="form-control" placeholder="Klasifikasi Debitur">
                            </div>
                        </div>
