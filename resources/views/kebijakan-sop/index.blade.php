    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right">
                <a class="btn btn-success" href="{{ route('kebijakan-sop.create') }}"> Create Kebijakan SOP</a>
            </div>
        </div>
    </div>
    <br>
...
@endif
    ...
    <table class="table table-bordered table-hover mb-0 text-md-nowrap border">
        ...
        <tr>
            ...
            <td>
                <form action="{{ route('kebijakan-sop.destroy', $item->id) }}" method="POST">
                    <a class="btn btn-info" href="{{ route('kebijakan-sop.show', $item->id) }}">Show</a>
                    <a class="btn btn-primary" href="{{ route('kebijakan-sop.edit', $item->id) }}">Edit</a>
                    @csrf
                    @method('DELETE')
